...
@FeignClient(name = "fabric", url = "http://211.69.197.137:8100")
public interface FabricFeignService {
    ...
    Response invokeChaincodeTest(@RequestParam("peers") String peers, @RequestParam("channel_name") String channelName, @RequestParam("cc_name") String ccName,
    ...
    Response getPolicy(@RequestParam("obj") String obj, @RequestParam("opt") String opt);
